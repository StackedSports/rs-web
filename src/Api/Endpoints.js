...
export const getContactAssociatedMedia = (id, page, perPage) => {
    return GET(`contacts/${id}/associated_media?page=${page}&per_page=${perPage}&sort_dir=desc`)
}
...
export const getBoards = () => {
    return AXIOS('get', `filters?page=1&per_page=100`)
}
...
export const getInboxConversation = ({ contact_id, inbox_type, user_id }, page, perPage) => {
    page = page || 1
    const body = {
